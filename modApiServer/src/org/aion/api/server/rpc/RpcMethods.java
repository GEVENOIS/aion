...
public class RpcMethods {
    ...
    private final Map<String, RpcMethod> ops = Map.ofEntries(
        ...
        Map.entry("ops_getTransactionReceiptByTransactionHash",
            (params) -> api.ops_getTransactionReceiptByTransactionHash(params)),
        Map.entry("ops_getTransactionReceiptByTransactionAndBlockHash",
            (params) -> api.ops_getTransactionReceiptByTransactionAndBlockHash(params)),
        Map.entry("ops_getTransactionReceiptListByBlockHash",
            (params) -> api.ops_getTransactionReceiptListByBlockHash(params))
    );
    /**
     * web3
     */
    ...
    private final Map<String, RpcMethod> eth = Map.ofEntries(
        ...
        Map.entry("eth_getBlockTransactionCountByHash",
            (params) -> api.eth_getBlockTransactionCountByHash(params)),
        Map.entry("eth_getBlockTransactionCountByNumber",
            (params) -> api.eth_getBlockTransactionCountByNumber(params)),
        Map.entry("eth_getTransactionByHash", (params) -> api.eth_getTransactionByHash(params)),
        Map.entry("eth_getTransactionByBlockHashAndIndex",
            (params) -> api.eth_getTransactionByBlockHashAndIndex(params)),
        Map.entry("eth_getTransactionByBlockNumberAndIndex",
        ...
        Map.entry("eth_newPendingTransactionFilter",
    ...
    private final Map<String, RpcMethod> priv = Map.ofEntries(
        ...
        Map.entry("priv_getPendingTransactions",
    ...
    private Map<String, RpcMethod> composite(final List<String> groups,
        ...
        for (String enabledMethod : enabledMethods) {
            if (allMethods.containsKey(enabledMethod)) {
                ...
                LOG.warn("rpc-methods - Attempted to enable unknown RPC method '{}'",
                    enabledMethod);
            }
        }
        ...
        for (String disabledMethod : disabledMethods) {
            if (composite.containsKey(disabledMethod)) {
                ...
                LOG.warn("rpc-methods - Attempted to disable unknown RPC method '{}'",
                    disabledMethod);
            }
        }
